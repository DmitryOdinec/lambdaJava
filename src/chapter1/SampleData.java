...
public class SampleData {
    ...
    public static final Album sampleShortAlbum2 = new Album("sample Short Album", 
												    		asList(new Track("short track", 30)), 
												    		asList(johnColtrane, theBeatles));
    
    public static final List<Album> albumsForTest = Arrays.asList(aLoveSupreme, sampleShortAlbum, manyTrackAlbum);
